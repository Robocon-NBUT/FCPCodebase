...
class FieldNoise
{
  ...
  private:
     ...
     * 				erf(-7)+erf(7.1) = -0.9999999(...) + 0.9999999(...) = -1+1 = 0 (due to lack of precision, even if
     * using double) if we use the proposed method: e^erf_aux(-7) - e^erf_aux(7.1) = -1.007340e-23 - -4.183826e-23
     * = 3.176486E-23
     *
