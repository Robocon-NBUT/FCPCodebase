...
void RobovizLogger::drawLine(float x1, float y1, float z1, float x2, float y2, float z2, float thickness, float r,
...
void RobovizLogger::drawCircle(float x, float y, float radius, float thickness, float r, float g, float b,
...
void RobovizLogger::drawSphere(float x, float y, float z, float radius, float r, float g, float b,
                               const string *setName)
{
...
void RobovizLogger::drawPoint(float x, float y, float z, float size, float r, float g, float b, const string *setName)
{
    float center[3] = {x, y, z};
    float color[3] = {r, g, b};
...
void RobovizLogger::drawPolygon(const float *v, int numVerts, float r, float g, float b, float a, const string *setName)
{
...
void RobovizLogger::drawAnnotation(const string *text, float x, float y, float z, float r, float g, float b,
                                   const string *setName)
{
    float color[3] = {r, g, b};
    float pos[3] = {x, y, z};
